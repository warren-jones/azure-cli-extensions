...
# Set up v-warrjones environment
$Env:AZURE_QUANTUM_WORKSPACE_RG = "v-warrjones" 
$Env:AZURE_QUANTUM_WORKSPACE_LOCATION = "westus"
$Env:AZURE_QUANTUM_WORKSPACE_STORAGE = "e2eqsharptests"
$Env:AZURE_QUANTUM_WORKSPACE_STORAGE_GRS = "e2eqsharptestsgrs"
