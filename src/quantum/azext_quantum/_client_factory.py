...
def cf_quantum(cli_ctx, subscription_id=None, resource_group_name=None, workspace_name=None, location=None):
    ...
    creds = _get_data_credentials(cli_ctx, subscription_id)
    # client = AzureQuantumWorkspaceServices(creds, subscription_id, resource_group_name, workspace_name, base_url=base_url(location), user_agent=get_appid())
    # client = AzureQuantumWorkspaceServices(creds, subscription_id, resource_group_name, workspace_name, user_agent=get_appid())
