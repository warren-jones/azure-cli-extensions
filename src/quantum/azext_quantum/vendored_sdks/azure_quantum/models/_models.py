...
class ItemDetails(_serialization.Model):
    ...
    def __init__(self, *, name: str, provider_id: str, target: str, **kwargs: Any) -> None:
        ...
        self.begin_execution_time: Optional[datetime.datetime] = None
        self.end_execution_time: Optional[datetime.datetime] = None
        self.cost_estimate: Optional["_models.CostEstimate"] = None
        self.error_data: Optional["_models.ErrorsWorkspaceItemError"] = None
...
class JobDetails(ItemDetails):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.cancellation_time: Optional[datetime.datetime] = None
        self.tags = tags
        self.quantum_computing_data: Optional["_models.QuantumComputingData"] = None
...
class ProviderStatus(_serialization.Model):
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        super().__init__(**kwargs)
        self.id: Optional[str] = None
        self.current_availability: Optional[Union[str, "_models.ProviderAvailability"]] = None
        self.targets: Optional[List["_models.TargetStatus"]] = None
...
class Quota(_serialization.Model):
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        self.scope: Optional[Union[str, "_models.DimensionScope"]] = None
        self.provider_id: Optional[str] = None
        self.utilization: Optional[float] = None
        self.holds: Optional[float] = None
        self.limit: Optional[float] = None
        self.period: Optional[Union[str, "_models.MeterPeriod"]] = None
...
class SessionDetails(ItemDetails):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.status: Optional[Union[str, "_models.SessionStatus"]] = None
...
class TargetStatus(_serialization.Model):
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        super().__init__(**kwargs)
        self.id: Optional[str] = None
        self.current_availability: Optional[Union[str, "_models.TargetAvailability"]] = None
        self.average_queue_time: Optional[int] = None
        self.status_page: Optional[str] = None
