...
class AzureQuantumWorkspaceServicesConfiguration:  # pylint: disable=too-many-instance-attributes,name-too-long
    """Configuration for AzureQuantumWorkspaceServices.
